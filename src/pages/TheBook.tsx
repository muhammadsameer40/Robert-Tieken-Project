...
const synopsisEN = {
  ...
  paragraphs: [
    'Robert is forty-something, living alone in Breda, cycling to work every morning and telling himself that this is enough. He has his school, his pupils, his best friend Sjoerd, and the quiet rhythm of a life that fits him like an old coat. Then a Phonecall arrives from a notary in the city of Breda. There is an inheritance. There is a cousin.',
    'What follows takes Robert from the flat green fields of the Netherlands to the sunlit harbour of Charlotteville, Michigan, where he meets a man who is technically a stranger but feels, from the very first conversation, like someone he has always known. Yet between them runs something real. A shared bloodline, a shared history neither of them knew they had, and a friendship that grows quickly and lasts.',
...
const synopsisNL = {
  ...
  paragraphs: [
    ...
    'Wat volgt, brengt Robert van de vlakke groene velden van Nederland naar de zonnige haven van Charlotteville, Michigan, waar hij een man ontmoet die technisch gezien een vreemde is, maar vanaf het eerste gesprek voelt als iemand die hij altijd al heeft gekend. Toch loopt er iets echts tussen hen. Een gedeelde bloedlijn, een gedeelde geschiedenis waarvan geen van beiden wist dat ze die hadden, en een vriendschap die snel groeit en blijft. ',
