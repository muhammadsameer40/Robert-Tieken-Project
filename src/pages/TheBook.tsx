...
const synopsisEN = {
  ...
  paragraphs: [
    'Robert is forty-something, living alone in Breda, cycling to work every morning and telling himself that this is enough. He has his school, his pupils, his best friend Sjoerd, and the quiet rhythm of a life that fits him like an old coat. Then a Phonecall arrives from a notary in the city of Breda. There is an inheritance. There is a cousin. And there is a name he has never heard before: Mike.',
    ...
    'Along the way, Robert encounters boat trips and beach lunches, a carnaval suit worn with pride, a puppy called Buddy, a steward on a transatlantic flight, and a swimming club that turns out to hold more than just good technique. He discovers things about himself he had never allowed himself to look at directly. And he begins, slowly and not without difficulty, to let his life become something larger.',
